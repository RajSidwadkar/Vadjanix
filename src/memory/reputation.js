...
import { nostrSend } from '../infrastructure/adapters/nostr.js';
/**
 ...
 */
export async function calculateReputation(pubkey) {
 ...
 */
export async function broadcastTrustScore(pubkey) {
